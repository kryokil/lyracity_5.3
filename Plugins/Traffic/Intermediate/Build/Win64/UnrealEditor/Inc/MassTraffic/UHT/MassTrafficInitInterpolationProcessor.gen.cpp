...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMassTrafficInitInterpolationProcessor_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "MassTrafficInitInterpolationProcessor.h" },
		{ "ModuleRelativePath", "Public/MassTrafficInitInterpolationProcessor.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UMassTrafficInitInterpolationProcessor_Statics::StaticCppClassTypeInfo = {
	...
	struct Z_CompiledInDeferFile_FID_lyracity_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficInitInterpolationProcessor_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_lyracity_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficInitInterpolationProcessor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMassTrafficInitInterpolationProcessor, UMassTrafficInitInterpolationProcessor::StaticClass, TEXT("UMassTrafficInitInterpolationProcessor"), &Z_Registration_Info_UClass_UMassTrafficInitInterpolationProcessor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassTrafficInitInterpolationProcessor), 1984028690U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_lyracity_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficInitInterpolationProcessor_h_164741368(TEXT("/Script/MassTraffic"),
		Z_CompiledInDeferFile_FID_lyracity_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficInitInterpolationProcessor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_lyracity_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficInitInterpolationProcessor_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
