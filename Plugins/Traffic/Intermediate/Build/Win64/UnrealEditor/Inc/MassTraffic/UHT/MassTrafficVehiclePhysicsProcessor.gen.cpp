...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMassTrafficVehiclePhysicsProcessor_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "MassTrafficVehiclePhysicsProcessor.h" },
		{ "ModuleRelativePath", "Public/MassTrafficVehiclePhysicsProcessor.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UMassTrafficVehiclePhysicsProcessor_Statics::StaticCppClassTypeInfo = {
	...
	struct Z_CompiledInDeferFile_FID_lyracity_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficVehiclePhysicsProcessor_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_lyracity_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficVehiclePhysicsProcessor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMassTrafficVehiclePhysicsProcessor, UMassTrafficVehiclePhysicsProcessor::StaticClass, TEXT("UMassTrafficVehiclePhysicsProcessor"), &Z_Registration_Info_UClass_UMassTrafficVehiclePhysicsProcessor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassTrafficVehiclePhysicsProcessor), 3744382339U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_lyracity_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficVehiclePhysicsProcessor_h_691456073(TEXT("/Script/MassTraffic"),
		Z_CompiledInDeferFile_FID_lyracity_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficVehiclePhysicsProcessor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_lyracity_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficVehiclePhysicsProcessor_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
