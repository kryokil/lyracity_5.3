...
#include "MassTraffic/Public/MassTrafficFindObstaclesProcessor.h"
...
// End Cross Module References
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UMassTrafficFindObstaclesProcessor);
	UClass* Z_Construct_UClass_UMassTrafficFindObstaclesProcessor_NoRegister()
	{
		return UMassTrafficFindObstaclesProcessor::StaticClass();
	}
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMassTrafficFindObstaclesProcessor_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "MassTrafficFindObstaclesProcessor.h" },
		{ "ModuleRelativePath", "Public/MassTrafficFindObstaclesProcessor.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UMassTrafficFindObstaclesProcessor_Statics::StaticCppClassTypeInfo = {
	...
	template<> MASSTRAFFIC_API UClass* StaticClass<UMassTrafficFindObstaclesProcessor>()
	{
		return UMassTrafficFindObstaclesProcessor::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UMassTrafficFindObstaclesProcessor);
	UMassTrafficFindObstaclesProcessor::~UMassTrafficFindObstaclesProcessor() {}
	struct Z_CompiledInDeferFile_FID_lyracity_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficFindObstaclesProcessor_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_lyracity_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficFindObstaclesProcessor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMassTrafficFindObstaclesProcessor, UMassTrafficFindObstaclesProcessor::StaticClass, TEXT("UMassTrafficFindObstaclesProcessor"), &Z_Registration_Info_UClass_UMassTrafficFindObstaclesProcessor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassTrafficFindObstaclesProcessor), 1539154102U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_lyracity_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficFindObstaclesProcessor_h_1761597269(TEXT("/Script/MassTraffic"),
		Z_CompiledInDeferFile_FID_lyracity_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficFindObstaclesProcessor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_lyracity_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficFindObstaclesProcessor_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
