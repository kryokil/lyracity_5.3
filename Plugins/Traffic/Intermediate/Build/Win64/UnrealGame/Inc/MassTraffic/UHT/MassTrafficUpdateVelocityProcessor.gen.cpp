...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMassTrafficUpdateVelocityProcessor_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "MassTrafficUpdateVelocityProcessor.h" },
		{ "ModuleRelativePath", "Public/MassTrafficUpdateVelocityProcessor.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UMassTrafficUpdateVelocityProcessor_Statics::StaticCppClassTypeInfo = {
	...
	struct Z_CompiledInDeferFile_FID_lyracity_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficUpdateVelocityProcessor_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_lyracity_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficUpdateVelocityProcessor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMassTrafficUpdateVelocityProcessor, UMassTrafficUpdateVelocityProcessor::StaticClass, TEXT("UMassTrafficUpdateVelocityProcessor"), &Z_Registration_Info_UClass_UMassTrafficUpdateVelocityProcessor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassTrafficUpdateVelocityProcessor), 905202732U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_lyracity_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficUpdateVelocityProcessor_h_4182224496(TEXT("/Script/MassTraffic"),
		Z_CompiledInDeferFile_FID_lyracity_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficUpdateVelocityProcessor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_lyracity_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficUpdateVelocityProcessor_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
