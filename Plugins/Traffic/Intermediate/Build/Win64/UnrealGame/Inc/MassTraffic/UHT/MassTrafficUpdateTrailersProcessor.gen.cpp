...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMassTrafficUpdateTrailersProcessor_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "MassTrafficUpdateTrailersProcessor.h" },
		{ "ModuleRelativePath", "Public/MassTrafficUpdateTrailersProcessor.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UMassTrafficUpdateTrailersProcessor_Statics::StaticCppClassTypeInfo = {
	...
	struct Z_CompiledInDeferFile_FID_lyracity_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficUpdateTrailersProcessor_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_lyracity_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficUpdateTrailersProcessor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMassTrafficUpdateTrailersProcessor, UMassTrafficUpdateTrailersProcessor::StaticClass, TEXT("UMassTrafficUpdateTrailersProcessor"), &Z_Registration_Info_UClass_UMassTrafficUpdateTrailersProcessor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassTrafficUpdateTrailersProcessor), 2657803944U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_lyracity_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficUpdateTrailersProcessor_h_1506422672(TEXT("/Script/MassTraffic"),
		Z_CompiledInDeferFile_FID_lyracity_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficUpdateTrailersProcessor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_lyracity_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficUpdateTrailersProcessor_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
