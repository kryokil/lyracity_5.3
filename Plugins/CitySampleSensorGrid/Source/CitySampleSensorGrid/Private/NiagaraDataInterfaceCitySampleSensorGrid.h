...
#include "NiagaraDataInterfaceCitySampleSensorGrid.generated.h"

/** Data Interface allowing spatial queries on 3d particles uniquely projected onto a 2d grid */
UCLASS(EditInlineNew, meta = (DisplayName = "CitySample Sensor Grid"))
class UNiagaraDataInterfaceCitySampleSensorGrid : public UNiagaraDataInterface
{
...
public:
	...
	UPROPERTY(EditAnywhere, Category = "User Data")
