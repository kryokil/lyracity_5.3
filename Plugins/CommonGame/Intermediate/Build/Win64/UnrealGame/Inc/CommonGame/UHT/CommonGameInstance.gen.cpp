...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UCommonGameInstance_HandlePrivilegeChanged_Statics::NewProp_UserInfo = { "UserInfo", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CommonGameInstance_eventHandlePrivilegeChanged_Parms, UserInfo), Z_Construct_UClass_UCommonUserInfo_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UCommonGameInstance_HandlePrivilegeChanged_Statics::NewProp_UserInfo_MetaData), Z_Construct_UFunction_UCommonGameInstance_HandlePrivilegeChanged_Statics::NewProp_UserInfo_MetaData) };
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UCommonGameInstance_HandlePrivilegeChanged_Statics::NewProp_Privilege = { "Privilege", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CommonGameInstance_eventHandlePrivilegeChanged_Parms, Privilege), Z_Construct_UEnum_CommonUser_ECommonUserPrivilege, METADATA_PARAMS(0, nullptr) }; // 2438391218
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UCommonGameInstance_HandlerUserInitialized_Statics::NewProp_UserInfo_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UCommonGameInstance_HandlerUserInitialized_Statics::NewProp_UserInfo = { "UserInfo", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CommonGameInstance_eventHandlerUserInitialized_Parms, UserInfo), Z_Construct_UClass_UCommonUserInfo_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UCommonGameInstance_HandlerUserInitialized_Statics::NewProp_UserInfo_MetaData), Z_Construct_UFunction_UCommonGameInstance_HandlerUserInitialized_Statics::NewProp_UserInfo_MetaData) };
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UCommonGameInstance_HandlerUserInitialized_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/CommonGameInstance.h" },
	};
#endif
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UCommonGameInstance_HandleSystemMessage_Statics::NewProp_MessageType = { "MessageType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CommonGameInstance_eventHandleSystemMessage_Parms, MessageType), Z_Construct_UScriptStruct_FGameplayTag, METADATA_PARAMS(0, nullptr) }; // 2083603574
...
#endif
		static const UECodeGen_Private::FObjectPtrPropertyParams NewProp_RequestedSession;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCommonGameInstance_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UCommonGameInstance_HandlePrivilegeChanged, "HandlePrivilegeChanged" }, // 3061647419
		{ &Z_Construct_UFunction_UCommonGameInstance_HandlerUserInitialized, "HandlerUserInitialized" }, // 2580915016
		{ &Z_Construct_UFunction_UCommonGameInstance_HandleSystemMessage, "HandleSystemMessage" }, // 2757635191
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCommonGameInstance_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UCommonGameInstance_Statics::NewProp_RequestedSession = { "RequestedSession", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCommonGameInstance, RequestedSession), Z_Construct_UClass_UCommonSession_SearchResult_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCommonGameInstance_Statics::NewProp_RequestedSession_MetaData), Z_Construct_UClass_UCommonGameInstance_Statics::NewProp_RequestedSession_MetaData) };
	...
	struct Z_CompiledInDeferFile_FID_lyracity_Plugins_CommonGame_Source_Public_CommonGameInstance_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_lyracity_Plugins_CommonGame_Source_Public_CommonGameInstance_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCommonGameInstance, UCommonGameInstance::StaticClass, TEXT("UCommonGameInstance"), &Z_Registration_Info_UClass_UCommonGameInstance, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCommonGameInstance), 573691641U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_lyracity_Plugins_CommonGame_Source_Public_CommonGameInstance_h_2049736374(TEXT("/Script/CommonGame"),
		Z_CompiledInDeferFile_FID_lyracity_Plugins_CommonGame_Source_Public_CommonGameInstance_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_lyracity_Plugins_CommonGame_Source_Public_CommonGameInstance_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
