...
#include "Validation/CitySampleValidator_Blueprints.h"
#include "Engine/Blueprint.h"
#include "Blueprint/BlueprintSupport.h"
#include "Kismet2/BlueprintEditorUtils.h"
#include "AssetRegistry/AssetRegistryModule.h"
#include "CitySampleEditor.h"
#include "Validation/CitySampleValidator_Load.h"
...
bool UCitySampleValidator_Blueprints::CanValidateAsset_Implementation(UObject* InAsset) const
{
	return Super::CanValidateAsset_Implementation(InAsset) && (InAsset ? InAsset->IsA(UBlueprint::StaticClass()) : false);
}

EDataValidationResult UCitySampleValidator_Blueprints::ValidateLoadedAsset_Implementation(UObject* InAsset, TArray<FText>& ValidationErrors)
{
