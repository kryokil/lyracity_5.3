...
void UCitySampleEditorBlueprintLibrary::SetNaniteSettings(UStaticMesh* StaticMesh, const bool bEnabled, const float PercentTriangles)
{
	StaticMesh->Modify();
...
bool UCitySampleEditorBlueprintLibrary::GetCollisionComplexity(const UStaticMesh* StaticMesh, TEnumAsByte<ECollisionTraceFlag>& Complexity)
{
	if (!StaticMesh)
	{
		return false;
...
void UCitySampleEditorBlueprintLibrary::SetNeverNeedsCookedCollisionData(UStaticMesh* StaticMesh, const bool bNeverNeedsCookedCollisionData)
{
...
void UCitySampleEditorBlueprintLibrary::CopyConstraintSettingsFromJointNames(UPhysicsAsset* SourcePhysicsAsset, const FName& SourceJointName, UPhysicsAsset* TargetPhysicsAsset, const FName& TargetJointName, const bool bKeepPosition, const bool bKeepRotation)
{
...
void UCitySampleEditorBlueprintLibrary::CopyConstraintSettingsFromBoneNames(UPhysicsAsset* SourcePhysicsAsset, const FName& SourceBone1Name, const FName& SourceBone2Name, UPhysicsAsset* TargetPhysicsAsset, const FName& TargetBone1Name, const FName& TargetBone2Name, const bool bKeepPosition, const bool bKeepRotation)
{
	if (!SourcePhysicsAsset || !TargetPhysicsAsset)
	{
		return;
...
void UCitySampleEditorBlueprintLibrary::CopyConstraintSettings(UPhysicsConstraintTemplate* FromConstraintSetup, UPhysicsConstraintTemplate* ToConstraintSetup, bool bKeepPosition, bool
                                                               bKeepRotation)
{
...
void UCitySampleEditorBlueprintLibrary::SetStatsShouldEmitNamedEvents(const bool bShouldEmitNamedEvents)
{
...
void UCitySampleEditorBlueprintLibrary::DeleteMaterialSlot(UStaticMesh* Mesh, const int32 MaterialIndex)
{
...
void UCitySampleEditorBlueprintLibrary::UpdateReimportPath(UStaticMesh* Mesh, const FString& Filename, const int32 SourceFileIndex)
{
	Mesh->Modify();
...
bool UCitySampleEditorBlueprintLibrary::IsMaterialIndexUsed(UStaticMesh* Mesh, const int32 MaterialIndex)
{
...
void UCitySampleEditorBlueprintLibrary::SetRayTracingGroupID(UStaticMeshComponent* StaticMeshComponent, const int32 RayTracingGroupID)
{
